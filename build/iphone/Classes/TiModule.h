...
/**
 The base class for all Whiskers modules
 */
...
/**
 Whiskers Platform calls this method on startup.
 */
-(void)startup;

/**
 Whiskers Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Whiskers Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Whiskers Platform calls this method on resume.
 @param sender The sender of the event.
 */

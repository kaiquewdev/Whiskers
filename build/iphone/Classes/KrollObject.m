 ...
 * Copyright (c) 2009-2011 by Whiskers, Inc. All Rights Reserved.
...
//@interface WhiskersObject : NSObject
//@end

@interface WhiskersObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WhiskersObject class]])
		{
			for (NSString *key in [[(WhiskersObject*)o modules] allKeys])
			{

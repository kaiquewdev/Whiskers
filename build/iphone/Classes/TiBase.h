...
// in simulator we redefine to format for Whiskers Developer console
...
{\
	NSString * exceptionName = [@"org.whiskers." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.whiskers";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIWhiskersNativeItemNone = -1, 
	UIWhiskersNativeItemSpinner = -2,
	UIWhiskersNativeItemProgressBar = -3,
	
	UIWhiskersNativeItemSlider = -4,
	UIWhiskersNativeItemSwitch = -5,
	UIWhiskersNativeItemMultiButton = -6,
	UIWhiskersNativeItemSegmented = -7,
	
	UIWhiskersNativeItemTextView = -8,
	UIWhiskersNativeItemTextField = -9,
	UIWhiskersNativeItemSearchBar = -10,
	
	UIWhiskersNativeItemPicker = -11,
	UIWhiskersNativeItemDatePicker = -12,
	
	UIWhiskersNativeItemInfoLight = -13,
	UIWhiskersNativeItemInfoDark = -14,
	
	UIWhiskersNativeItemDisclosure = -15,
	
	UIWhiskersNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Whiskers instances of
